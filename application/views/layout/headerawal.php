        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    <a href="<?= base_url('BerandaAwal/'); ?>" class="nav-item nav-link<?= ($this->uri->segment(1) == 'berandaawal') ? 'active' : ''; ?>">Home</a>
                    <a href="<?= base_url('Education/clone'); ?>" class="nav-item nav-link">Education</a>
                    <a href="<?= base_url('AquaHub/view'); ?>" class="nav-item nav-link">AquaHub</a>
                </div>
                <a href="<?= base_url('Auth/login'); ?>" class="btn btn-info rounded-pill px-3 d-none d-lg-block">Login<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->